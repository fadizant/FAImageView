#
# Be sure to run `pod lib lint FAImageView.podspec' to ensure this is a
...
#s.description      = <<-DESC TODO: Add long description of the pod here. DESC
  ...
  s.source_files = 'FAImageView/Classes/**/*'
  
  # s.resource_bundles = {
  #   'FAImageView' => ['FAImageView/Assets/*.png']
  # }
